...
export function ShareScoreboardDialog({ isOpen, onClose, eloRatings }: ShareScoreboardDialogProps) {
        ...
        <div class={styles.shareContent}>
          ...
          <div class={styles.inputGroup}>
            ...
            <input
              ...
              placeholder={
                currentTheme ? `e.g., My ${currentTheme.name.split(' ')[0]} Top 10` : 'Enter name'
              }
